module.exports = [
"[project]/node_modules/@tensorflow/tfjs-layers/dist/backend/state.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/backend/common.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/backend/tfjs_backend.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function repeat(x, n) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tidy"])(()=>{
        if (x.shape.length !== 2) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`repeat() expects a rank-2 tensor, but received a ` + `rank-${x.shape.length} tensor.`);
        }
...
function flatten(x) {
    const newShape = [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$math_utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayProd"](x.shape)
    ];
...
function batchFlatten(x) {
    if (x.rank <= 1) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`batchFlatten requires a minimum rank of 2. Got rank: ${x.rank}.`);
    }
    const newShape = [
        x.shape[0],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$math_utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayProd"](x.shape, 1)
    ];
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reshape"](x, newShape);
}
function sliceAlongFirstAxis(array, start, size) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tidy"])(()=>{
        switch(array.rank){
            ...
            default:
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`sliceAlongFirstAxis() received an unsupported tensor rank: ` + `${array.rank}`);
        }
    });
}
function sliceAlongLastAxis(array, start, size) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tidy"])(()=>{
        switch(array.rank){
            ...
            default:
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`sliceAlongLastAxis() received an unsupported tensor rank: ` + `${array.rank}`);
        }
    });
}
        ...
        switch(array.rank){
            ...
            case 2:
                switch(axis){
                    ...
                    default:
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`The axis is not within the rank of the tensor ` + `${axis}`);
                }
            case 3:
                switch(axis){
                    case 1:
...
function concatAlongFirstAxis(a, b) {
    switch(a.rank){
        ...
        default:
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`concatAlongFirstAxis() received an unsupported ` + `tensor rank: ${a.rank}`);
    }
}
function tile(x, n) {
    if (!Array.isArray(n)) {
    ...
    if (x.rank !== n.length) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`The length of input n (${n.length}) does not match ` + `the number of dimensions in input x (${x.rank})`);
    }
...
function dot(a, b, activation, bias) {
    if (a.rank < 2 || b.rank < 2) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NotImplementedError"](`dot requires both inputs to be rank >= 2` + ` but got x shape = ${a.shape} and y shape = ${b.shape}`);
    }
    if (b.rank >= 3) {
    ...
    if (a.rank === 2 && b.rank === 2) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_ops$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__fused$3e$__["fused"].matMul({
            ...
            transposeA,
            transposeB,
            bias: bias ? reshapeBias(a.rank, bias, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$backend$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["imageDataFormat"])()) : null,
            activation
        });
    } else {
...
function pow(x, a) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tidy"])(()=>{
        ...
        if (a.dtype !== 'int32') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NotImplementedError"](`Non-int32 dtype (${a.dtype}) is not supported by pow() yet`);
        }
 ...
 */ function reshapeBias(xRank, bias, dataFormat) {
    ...
    if (bias.rank !== 1 && bias.rank !== xRank) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`Unexpected bias dimensions: ${bias.rank}` + `; expected it to be 1 or ${xRank}`);
    }
    if (xRank === 5) {
    ...
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ValueError"](`Unsupported input rank by biasAdd: ${bias.rank}`);
}
...
function elu(x, alpha = 1) {
    ...
    if (alpha !== 1) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NotImplementedError"](`Support for alpha values other than 1 (${alpha}) is not implemented ` + `yet.`);
    }
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/backend/random_seed.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-layers_dist_backend_aa8ed35f._.js.map